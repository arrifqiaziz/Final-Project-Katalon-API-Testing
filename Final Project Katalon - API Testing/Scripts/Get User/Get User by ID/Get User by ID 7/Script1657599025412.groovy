...
Response = WS.sendRequest(findTestObject('Get User/Get User by ID/Get User by ID 7'))
...
WS.verifyElementPropertyValue(Response, 'data.avatar', 'https://reqres.in/img/faces/7-image.jpg')
