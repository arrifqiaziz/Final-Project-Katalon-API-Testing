...
Response = WS.sendRequest(findTestObject('GET User/Get User by ID/Get User by ID 1', [('x') : 1]))
...
WS.verifyElementPropertyValue(Response, 'data.avatar', 'https://reqres.in/img/faces/1-image.jpg')
