...
Response = WS.sendRequest(findTestObject('Get User/Get User by ID/Get User by ID 4'))
...
WS.verifyElementPropertyValue(Response, 'data.first_name', 'Eve')

WS.verifyElementPropertyValue(Response, 'data.last_name', 'Holt')

WS.verifyElementPropertyValue(Response, 'data.avatar', 'https://reqres.in/img/faces/4-image.jpg')
